...
public class Player : MonoBehaviour
{
   ...
   /* public string GETMYINFO()
    {
        myInfo = "LV . " + PLAYERLEVEL.ToString() + "\n" + "EXP / MAXEXP . " + PLAYERCUREXP.ToString() + " / " + PLAYERMAXEXP.ToString() + "\n" + "HP / MAXHP . " + PLAYERCURHP.ToString() + " / " + PLAYERMAXHP.ToString() + "\n" + "Attack Power / Range . " + PLAYERATTACKPOWER.ToString() + " / " + PLAYERATTACKRANGE.ToString() + "\n" + "Gold . " + GOLD.ToString() + "\n" + "Potion . " + POTION.ToString();
    ...
    private void Update()
    {
        myInfo = "LV" + PLAYERLEVEL.ToString() + "\n" + "EXP / MAXEXP " + PLAYERCUREXP.ToString() + " / " + PLAYERMAXEXP.ToString() + "\n" + "HP / MAXHP . " + PLAYERCURHP.ToString() + " / " + PLAYERMAXHP.ToString() + "\n" + "Attack Power / Attack Range " + PLAYERATTACKPOWER.ToString() + " / " + PLAYERATTACKRANGE.ToString() + "\n" + "Gold " + GOLD.ToString() + "\n" + "Potion " + POTION.ToString();
    ...
    private void OnCollisionEnter(Collision collision)
    {
        ...
        if (collision.collider.CompareTag("End"))
        {
            ...
            UIManager.INSTANCE.GETMOBINFO(MOBINFO.BOSS); // 무조건 보스가 출현
        }
    }
    ...
    private void OnTriggerEnter(Collider collider)
    {
        ...
        if (collider.gameObject.TryGetComponent<Monster>(out monster) == true) //(collision.collider.CompareTag("Monster"))
        {
            ...
            UIManager.INSTANCE.GETMOBINFO(monster.MOBINFO); // UI에 몬스터 정보 출력
        }
    }
